	...
	render() {
		return (
			<div className="container2">
				<div>
					<h1 style={{ fontSize: "45px" }}>Lazarus Rising</h1>
					<p style={{ fontWeight: "200" }}>Workshop portal for Lazarus Rising.</p>
				</div>
				<div style={{
					background: "white", width: "30%", height: "auto", padding: "20px", minWidth: "400px",
					textAlign: "center", margin: "auto", marginTop: "100px"
				}}>
					<p style={{ margin: 0, fontWeight: "bold", paddingRight: "50px" }}>Start or join a session</p>
