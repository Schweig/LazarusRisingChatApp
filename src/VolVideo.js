...
const server_url = process.env.NODE_ENV === 'production' ? 'https://lazarus.wschweigert.com' : "http://localhost:4001"
...
class VolVideo extends Component {
	constructor(props) {
		super(props)
		...
		if(this.isChromeOrFirefox() === false){
			return (
				<div style={{
					...
					<h1>Please use Chrome or Firefox</h1>
				</div>
			)
		}
		return (
					...
					<div>
						...
						<div className="container">
							...
							<div style={{
								...
								<Button onClick={()=>{document.querySelector('#my-video').style.display = "none"}} style={{zIndex:1000}}>Minimize</Button>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
									margin: "10px",
									objectFit: "fill",
									height: "224px",
									width: "280px",
									mosTransform: 'scale(-1, 1)',
							...
							{this.state.numUsers === 1 && 
									<div>Participant not here yet</div>
								}
							</Row>
						</div>
